...
<%@ page import="com.openscg.pgstudio.server.util.ConnectionInfo" %>
<%@ page import="com.openscg.pgstudio.server.util.ConnectionManager" %>
<%@ page import="com.openscg.pgstudio.shared.DatabaseConnectionException" %>
...
<html>
  ...
  <!--[if IE 9]> <meta http-equiv="X-UA-Compatible" content="IE=9"> <![endif]-->
    ...
    <%
        String dbURL = System.getenv("PG_HOST");
        int dbPort = Integer.parseInt(System.getenv("PG_PORT"));
        String dbName = System.getenv("PG_DBNAME");
        if(dbName==null)
    	dbName="";
        String username = System.getenv("PG_USERNAME");
        String passwd = System.getenv("PG_PASSWORD");
...
%>
        ...
        <form name="sdb_11_11_28" class="connectform" method="post" action="login">
            <fieldset>
                ...
                <div class="row clearfix ">
                    ...
                    <div class="span1">
                        <input id="username" tabindex="4" maxlength="75" type="text" class="required" name="username" value="<%=((request.getSession().getAttribute("username") == null || "".equals(request.getSession().getAttribute("username"))) ? "" : request.getSession().getAttribute("username")) %>">
                    </div>
                </div>
                ...
                <div class="row clearfix ">
                    ...
                    <div class="span1">
                        <input tabindex="5" maxlength="75" type="password" name="password" id="password" class="required">
                    </div>
                </div>
              </fieldset>
  ...
  <div class="studiocontainer widebase ">
    ...
    <span id="version">PostgreSQL Studio v2.0</span>
